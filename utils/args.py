...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--target-url", type=str, default="https://campusonline.unir.net/my", help="Link de login de UNIR/Moodle (UNIR por defecto)")
    # Might be used to adapt the bot for other Moodle courses
